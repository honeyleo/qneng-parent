...
<html lang="en">
		...
		<script type="text/javascript">
				...
				function save(){
					...
					$.ajax({
			            type: "POST",
			            dataType: "json",
			            url: "<%=basePath %>manager/menu/editIcon",
	...
	<body>
		<form action="<%=basePath %>manager/menu/editIcon" name="menuForm" id="menuForm" method="post">
			...
			<div id="zhongxin2" class="center" style="display:none"><img src="<%=basePath %>resources/images/jzx.gif" /></div>
		</form>
	</body>
</html>